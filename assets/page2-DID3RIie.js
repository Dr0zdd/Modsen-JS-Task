import{g as c,I as i,c as o}from"./theme-manager-DwCWArvu.js";document.addEventListener("DOMContentLoaded",()=>{const e=document.querySelector(".card__wrapper"),r=c();if(e){if(!r.length){e.innerHTML=`
